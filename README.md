...
Download the datasets [Nutrition5K](https://github.com/google-research-datasets/Nutrition5k) and [MetaFood3D](https://lorenz.ecn.purdue.edu/~food3d/).
...
# Checkpoints 📂
Here we release the checkpoints and prediction results (mean absolute percentage error) of the model in the nutrition estimation task: [Depth-Nutrition](https://pan.baidu.com/s/1k_iwU1YFuyaVgk0Godad9A?pwd=jpei)
